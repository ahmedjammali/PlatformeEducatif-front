...
@Component({
  selector: 'app-invoice-proformat-dialog',
  template: `
    <div class="invoice-proformat-dialog-overlay invoice-proformat-print-container" (click)="onOverlayClick($event)">
      <div class="invoice-proformat-dialog-container" (click)="$event.stopPropagation()">
        <div class="invoice-proformat-dialog-header no-print">
        ...
        <div class="invoice-proformat-dialog-content">
  ...
  `,
  styles: [`
    .invoice-proformat-dialog-overlay {
      position: fixed;
      top: 0;
      left: 0;
      right: 0;
    ...
    .invoice-proformat-dialog-container {
    ...
    .invoice-proformat-dialog-header {
    ...
    .invoice-proformat-dialog-content {
      flex: 1;
      overflow-y: auto;
      padding: 0;
...
export class InvoiceProformatDialogComponent implements OnInit, OnDestroy {
...
@Input() componentOnly?: 'uniform' | 'inscriptionFee' | 'tuition'; // ✅ ADD 'tuition'
  ...
  ngOnInit(): void {
    ...
    document.body.classList.add('invoice-proformat-dialog-open');
  ...
  ngOnDestroy(): void {
    ...
    document.body.classList.remove('invoice-proformat-dialog-open');
  ...
  closeDialog(): void {
    const container = document.querySelector('.invoice-proformat-dialog-container') as HTMLElement;
    const overlay = document.querySelector('.invoice-proformat-dialog-overlay') as HTMLElement;
